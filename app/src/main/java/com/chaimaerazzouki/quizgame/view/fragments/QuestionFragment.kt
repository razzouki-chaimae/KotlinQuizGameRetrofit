...
class QuestionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        option1button.text = currentQuestionEntity.correct_answer
        option2button.text = currentQuestionEntity.incorrect_answers[0]
        option3button.text = currentQuestionEntity.incorrect_answers[1]
        option4button.text = currentQuestionEntity.incorrect_answers[2]
